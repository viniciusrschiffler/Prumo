...
export function buildSeedData(shift: DateShifter): TableSeed[] {
  ...
  return [
    ...
    },
    {
      ...
      rows: [
        ['td-escopo', 'Fechar escopo do módulo de conciliação com o time financeiro', null, date('2026-09-03'), 'P1', 'open', 'gateway', 'gw-cut', null, null],
        ['td-parceiro', 'Responder proposta de replanejamento do parceiro', null, date('2026-09-03'), 'P0', 'open', 'parceiro', null, null, null],
        ...
        ['td-roteiro', 'Preparar roteiro do cutover', null, date('2026-09-10'), 'P2', 'open', 'gateway', 'gw-cut', null, null],
        ['td-contrato', 'Cobrar o contrato assinado do parceiro', null, date('2026-08-30'), 'P0', 'open', 'parceiro', 'pp-jur', null, null],
